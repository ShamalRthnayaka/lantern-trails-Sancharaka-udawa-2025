...
const Footer = () => {
  return (
    <footer className="bg-[#0b4b46] text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Discover the beauty of Sri Lanka with authentic, sustainable, and unforgettable travel experiences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start">
                ...
                <span>123 Adventure Road, Colombo, Sri Lanka</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span>info@lanterntrails.travel</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form className="flex">
              ...
              <button
                type="submit"
                className="bg-[#12756d] px-4 py-2 rounded-r-md hover:bg-[#0d5952]"
              >
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="text-center text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Lantern Trails. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
